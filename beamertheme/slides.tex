	...
	\begin{table}[ht]
		...
		\resizebox{.85\textwidth}{!}{%
			\begin{tabular}{lccc}
				...
				Dataset D - \# of changed predictions total        & 1066               & 420                    & 382                  \\ %\hline
				Dataset E - \# of changed predictions per sentence & 790                & 259                    & 253                  \\ \midrule
				\textbf{Overall Success Rate}                      & \textbf{47.76\%}   & \textbf{31.01\%}       & \textbf{14.95\%}     \\ \bottomrule
				\textbf{Distinct Success Rate}                     & \textbf{88.07\%}   & \textbf{70.19\%}       & \textbf{26.83\%}     \\ \bottomrule
			\end{tabular}%
		}
