...
\begin{frame}
	...
	\begin{table}[ht]
		...
		\resizebox{.85\textwidth}{!}{%
			\begin{tabular}{lccc}
				\toprule
				\textbf{Perturbation Method}                               & \textbf{Leetspeak} & \textbf{ Misspellings} & \textbf{Punctuation} \\ \midrule
				Dataset A - \# of original sentences                       & 943                & 943                    & 943                  \\ %\hline
				Dataset B - \# of modifiable original sentences            & 897                & 369                    & 943                  \\ %\hline
				Dataset C - \# of adversarial sentences                    & 2232               & 1354                   & 2555                 \\ %\hline
				Dataset D - \# of changed predictions through modification & 1066               & 420                    & 382                  \\ \midrule
				\textbf{Attack Success Rate}                               & \textbf{47.76\%}   & \textbf{31.01\%}       & \textbf{14.95\%}     \\ \bottomrule
			\end{tabular}%
		}
